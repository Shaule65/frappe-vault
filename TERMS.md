...
Please read these Terms and Conditions carefully before using Frappe Vault. By downloading, installing, or using Frappe Vault, you agree to be bound by these Terms.

## 1. Nature of the Software
Frappe Vault is a free, open-source application. It is provided to the community to be self-hosted and managed by the user.
...
## 4. Limitation of Liability (Zero Liability)
...
The maintainers reserve the right to modify, suspend, or discontinue the development of the software at any time without notice.

## 6. User Responsibilities
As a user of this self-hosted software, you are solely responsible for:
- Ensuring the software is installed securely and updated regularly.
- Creating regular backups of your data.
- Complying with all applicable laws and regulations in your jurisdiction regarding the use of this software.

## 7. Changes to Terms
We reserve the right to modify these Terms and Conditions at any time. Continued use of the software after any such changes shall constitute your consent to such changes.
